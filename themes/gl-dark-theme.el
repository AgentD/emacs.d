...
;; '(mode-line ((t (:foreground "#ffffff" :background "#292929" :box "#fb1020"))))
;; '(mode-line-inactive ((t (:foreground "#ffffff" :background "#000000" :box "#939393"))))
 ...
 '(linum ((t (:foreground "#fda331" :background "#292929" :underline nil))))	
